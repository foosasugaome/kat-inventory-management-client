...
import PurchasesListDetail from "./PurchasesListDetails"
...
{
          showTransForm ? 
          <PurchasesListDetail setMessage={setMessage} showTransForm={showTransForm} setShowTransForm={setShowTransForm} inventoryId={inventoryId} />
          :
          null
      }
        </>
